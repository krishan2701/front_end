...
import sonyData from "../../assets/Televesions/Sony/Sony.json";
import "bootstrap/dist/css/bootstrap.min.css";
import "./SonyPage.scss";
...
const SonyPage = () => {
  ...
  return (
    <div className="container sony-page">
      <h1 className="my-4">Sony Televisions</h1>
      <div className="row">
