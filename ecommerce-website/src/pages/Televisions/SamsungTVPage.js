...
import samsungData from "../../assets/Televesions/SamsungTv/Samsung.json";
import "bootstrap/dist/css/bootstrap.min.css";
import "./SamsungTVPage.scss";
...
const SamsungTVPage = () => {
  ...
  return (
    <div className="container samsungtv-page">
      <h1 className="my-4">Samsung Televisions</h1>
      <div className="row">
