...
import lenovoData from "../../assets/Laptops/Lenovo/Lenovo.json";
import "bootstrap/dist/css/bootstrap.min.css";
import "./LenovoPage.scss";
...
const LenovoPage = () => {
  ...
  return (
    <div className="container lenovo-page">
      <h1 className="my-4">Lenovo Products</h1>
      <div className="row">
